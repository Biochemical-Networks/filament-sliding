...
/* Set the widths of the columns of the input file, used when a line is written
 * while restoring a default input file. constexpr explicitly shows that these
 * are compile time constants, even though it should be the same as using const.
