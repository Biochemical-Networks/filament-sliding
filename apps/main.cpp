...
int main() {
    ...
    Input input; // Read the input file, ask to create a default one when
                 // anything is wrong with it (e.g. nonexistent)
    ...
    if (maximumStretchPerLatticeSpacing <= 0.0) {
        throw GeneralException(
                "The parameter maximumStretchPerLatticeSpacing contains a "
                "wrong value.");
    }
    ...
    input.copyParameter(
            "addTheoreticalCounterForce", addTheoreticalCounterForceString);
    const bool addTheoreticalCounterForce =
            (addTheoreticalCounterForceString ==
    ...
    if (baseRateOneToTwoExtremitiesConnected < 0.0) {
        throw GeneralException(
                "The parameter baseRateOneToTwoExtremitiesConnected contains a "
                "wrong value.");
    }
    ...
    if (baseRateTwoToOneExtremitiesConnected < 0.0) {
        throw GeneralException(
                "The parameter baseRateTwoToOneExtremitiesConnected contains a "
                "wrong value.");
    }
