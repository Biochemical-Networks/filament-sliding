...
Crosslinker::Crosslinker(const Type type):
        m_type(type),
        m_head(false), // A crosslinker always starts as a free one,
...
void Crosslinker::disconnectFromPartialConnection() {
    ...
    if (!isPartial()) {
        throw GeneralException(
                "Crosslinker::disconnectFromPartialConnection() was "
...
void Crosslinker::fullyConnectFromPartialConnection(
    ...
    if (!isPartial()) {
        throw GeneralException(
                "Crosslinker::fullyConnectFromPartialConnection() "
...
void Crosslinker::disconnectFromFullConnection(
    ...
    default:
        throw GeneralException(
                "Crosslinker::disconnectFromFullConnection() was "
...
Crosslinker::Terminus Crosslinker::getFreeTerminusWhenPartiallyConnected()
    ...
    if (!isPartial()) {
        throw GeneralException(
                "Crosslinker::getFreeTerminusWhenPartiallyConnected("
...
SiteLocation Crosslinker::getOneBoundLocationWhenFullyConnected(
    ...
    if (!isFull()) {
        throw GeneralException(
                "Crosslinker::getOneBoundLocationWhenFullyConnected("
    ...
    default:
        throw GeneralException(
                "Crosslinker::getOneBoundPositionWhenFullyConnected("
