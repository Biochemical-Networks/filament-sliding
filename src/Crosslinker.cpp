...
Crosslinker::Crosslinker(const Type type):
        m_type(type),
        m_head(false), // A crosslinker always starts as a free one, because it
...
SiteLocation Crosslinker::getSiteLocationOf(
...
void Crosslinker::connectFromFree(
...
// an extremity, it is also checked whether those are not connected already.
    ...
    default:
        throw GeneralException(
                "An incorrect crosslinker terminus was passed to "
...
void Crosslinker::disconnectFromPartialConnection() {
    ...
    if (!isPartial()) {
        throw GeneralException(
                "Crosslinker::disconnectFromPartialConnection() was called "
                "from a crosslinker in a different state");
    }
#endif // MYDEBUG
...
void Crosslinker::fullyConnectFromPartialConnection(
    ...
    if (!isPartial()) {
        throw GeneralException(
                "Crosslinker::fullyConnectFromPartialConnection() was called "
...
void Crosslinker::disconnectFromFullConnection(
    ...
    default:
        throw GeneralException(
                "Crosslinker::disconnectFromFullConnection() was passed a "
                "wrong Terminus.");
        break;
    }
}

Crosslinker::Terminus Crosslinker::getFreeTerminusWhenPartiallyConnected()
        const {
#ifdef MYDEBUG
    if (!isPartial()) {
        throw GeneralException(
                "Crosslinker::getFreeTerminusWhenPartiallyConnected() was "
                "called on a non-partial");
    }
#endif // MYDEBUG
...
Crosslinker::Terminus Crosslinker::getBoundTerminusWhenPartiallyConnected()
        const {
#ifdef MYDEBUG
    if (!isPartial()) {
        throw GeneralException(
                "Crosslinker::getBoundTerminusWhenPartiallyConnected() was "
                "called on a non-partial");
    }
#endif // MYDEBUG
...
Crosslinker::Terminus Crosslinker::getTerminusOfFullOn(
        const MicrotubuleType microtubule) const {
#ifdef MYDEBUG
    if (!isFull()) {
        throw GeneralException(
                "Crosslinker::getTerminusOfFullOn() was called on a non-full "
                "linker");
    }
    else if (
            m_tail.getMicrotubuleConnectedTo() ==
            m_head.getMicrotubuleConnectedTo()) {
        throw GeneralException(
                "Crosslinker::getTerminusOfFullOn() was called on a linker "
                "that was connected to one microtubule twice");
    }
#endif // MYDEBUG
...
SiteLocation Crosslinker::getLocationOfFullOn(
        const MicrotubuleType microtubule) const {
#ifdef MYDEBUG
    if (!isFull()) {
        throw GeneralException(
                "Crosslinker::getLocationOfFullOn() was called on a non-full "
                "linker");
    }
    else if (
            m_tail.getMicrotubuleConnectedTo() ==
            m_head.getMicrotubuleConnectedTo()) {
        throw GeneralException(
                "Crosslinker::getLocationOfFullOn() was called on a linker "
                "that was connected to one microtubule twice");
    }
#endif // MYDEBUG
...
SiteLocation Crosslinker::getBoundLocationWhenPartiallyConnected() const {
    ...
    if (!isPartial()) {
        throw GeneralException(
                "Crosslinker::getBoundLocationWhenPartiallyConnected() was "
                "called on a non-partial");
    }
#endif // MYDEBUG
...
SiteLocation Crosslinker::getOneBoundLocationWhenFullyConnected(
    ...
    if (!isFull()) {
        throw GeneralException(
                "Crosslinker::getOneBoundLocationWhenFullyConnected() was "
                "called on a non-full");
    }
#endif // MYDEBUG
    ...
    default:
        throw GeneralException(
                "Crosslinker::getOneBoundPositionWhenFullyConnected() was "
