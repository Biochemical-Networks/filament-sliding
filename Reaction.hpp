 ...
 * To change the SystemState, a Reaction uses methods of SystemState, and Reactions are called by the Propagator,
 * such that direct manipulation of the SystemState is shielded away from the Propagator.
 */

class Reaction
{
protected: // Protected, since the inherited classes need access to these.
    // Do not include an elementary rate, since there may be several (this is the case for HopFull)
